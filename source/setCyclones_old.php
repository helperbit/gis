...
$oggi = time();
$link = "https://api.sigimera.org/v1/crises?auth_token=-TsJzSbzAzUp11exrja8&type=cyclones";
...
foreach ($obj as $value) {
    ...
    if ($stmt->execute($params)) {
        ...
        email_sender("NEW SYSTEM: Creato evento cyclones", "Creato evento cyclones $sigimera_id .");
        //update 
