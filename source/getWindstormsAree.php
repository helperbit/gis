...
SELECT gdacs_id,
     ST_Multi(st_makevalid(ST_Union(windstorms_area.geom))) as geom
FROM windstorms_area
...
SELECT row_to_json(fc)
     ...
     FROM (SELECT 'Feature' As type
       ...
       FROM poly, public.windstorms
		   left join capitali on capitali.iso_3c = windstorms.country   LEFT join countries_centroid on countries_centroid.iso_3digit = windstorms.country
		   where windstorms.gdacs_id = poly.gdacs_id
        ) As f )  As fc";
