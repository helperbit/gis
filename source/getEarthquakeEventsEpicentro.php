...
$stringaQuery = "SELECT row_to_json(fc)
  ...
  old_data_evento, old_tsunami, old_depth, old_mag, old_country, 
       ...
       where  array_length(affected_countries, 1) < 6 and  st_intersects(inviluppo_buffer_evento,st_transform(geom,900913)) 
...
order by lg.last_shake_time DESC limit $limit offset $offset
        ) As f )  As fc;";
