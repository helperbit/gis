...
$link = "https://www.gdacs.org/datareport/resources/TC/";
$sec = 0;
$ch = curl_init();
...
// GET ALL THE ID_EVENTO
            ...
            $stringaQuery = "SELECT * FROM public.cyclones WHERE gdacs_id = '$id_gdacs'";
            ...
            if ($resultselect->rowCount() == 0) { // EVENTO NUOVO
                ...
                $linkgeojson = "/datareport/resources/TC/" . $end[1] . "/geojson_" . $end[1] . "_" . $last_episodio . ".geojson";
                ...
                $xml = getxml($preurl, "TC", ".xml", $end[1], $last_episodio, "/rss_");
                ...
                if ($xml) {
                    if ($xml->channel) {
                        ...
                        $sql = "INSERT INTO public.cyclones(
                 gdacs_id, created_at, crisis_alert_level, crisis_event_episode, crisis_population, crisis_severity, crisis_severity_hash, crisis_vulnerability, crisis_vulnerability_hash, dc_date, dc_description, dc_title, gn_parent_country, geom)
                  VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, st_setsrid(ST_MakePoint(?,?),4326));";
                        ...
                        $sql = "INSERT INTO public.cyclones( gdacs_id, created_at, crisis_alert_level, crisis_event_episode, crisis_population, crisis_severity,  crisis_vulnerability, dc_date, dc_description, dc_title, gn_parent_country, geom)
                    ...
                    if ($todate >= $controldate) {
                        ...
                        if ($crisis_alertLevel != "Green") {
                            ...
                            if ($stmt->execute($params)) {
                                echo "INSERITO IN cyclones $gdacs_id WITH EVENT EPISODE : $event_episode <br>";
                                email_sender("NEW SYSTEM: Creato evento cyclones", "Creato evento cyclones $gdacs_id .");
                                //update
                                ...
                                $updateSql = 'UPDATE public.cyclones
                            ...
                            where gdacs_id = ?';
                                ...
                                foreach ($features as $feature) {
                                    ...
                                    if ($geometry['type'] == "Polygon" || $geometry['type'] == "MultiPolygon") {
                                        ...
                                        //$features = $obj['features'];
                                        $geominser_query = "INSERT INTO public.cyclones_area(
                                        ...
                                        if ($stmt->execute($params)) {
                                            ...
                                            print "\n";
                                            print_r('NEW polygon inserted into cyclones_area ' . " --> " . $gdacs_id . " with alert level -> " . $polygontype);
                                            print "\n";
                                        } else {
              ...
              /*  print "\n";
                ...
                if ($xml) {
                    if ($xml->channel) {
                        ...
                        $sqlupdate_test = "UPDATE public.cyclones
                        ...
                        if ($crisis_alertLevel != "Green") {
                            ...
                            if ($last_episodio > $crisis_event_episode) {
                              ...
                              if ($stmt00->execute($params)) {
                                  ...
                                  print "\n";
                                  email_sender("NEW SYSTEM: Aggiornato evento cyclones", "Aggiornato evento cyclones $gdacs_id .");
                              } else {
                                  print "\n";
                                  print "\n";
                                ...
                                $stringadelete = "DELETE FROM public.cyclones_area
                              	WHERE gdacs_id = ?";
