...
// GET ALL THE ID_EVENTO
            ...
            $stringaQuery = "SELECT * FROM public.floods WHERE gdacs_id = '$id_gdacs'";
...
try {
                        ...
                        $sql = "INSERT INTO public.floods( gdacs_id, created_at, crisis_alert_level, crisis_event_episode, crisis_population, crisis_severity,  crisis_vulnerability, dc_date, dc_description, dc_title, gn_parent_country, geom)
                    ...
                    if ($todate >= $controldate) {
                        ...
                        if ($crisis_alertLevel != "Green") {
                            ...
                            if ($stmt->execute($params)) {
                                echo "INSERITO IN floods $gdacs_id WITH EVENT EPISODE : $event_episode <br>";
                                email_sender("NEW SYSTEM: Creato evento flood", "Creato evento floods $gdacs_id .");
                                //update
              ...
              /*  print "\n";
                ...
                if ($xml) {
                    if ($xml->channel) {
                        ...
                        $sqlupdate_test = "UPDATE public.floods
                        ...
                        if ($crisis_alertLevel != "Green") {
                            ...
                            if ($last_episodio > $crisis_event_episode) {
                              ...
                              if ($stmt00->execute($params)) {
                                  ...
                                  print "\n";
                                 email_sender("NEW SYSTEM: Aggiornato evento flood", "Aggiornato evento floods $gdacs_id .");
                              } else {
                                  print "\n";
                                  print "\n";
