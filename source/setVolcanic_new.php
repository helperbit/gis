...
// GET ALL THE ID_EVENTO
            ...
            $stringaQuery = "SELECT * FROM public.volcanic_test WHERE gdacs_id = '$id_gdacs'";
            ...
            if ($resultselect->rowCount() == 0) { // EVENTO NUOVO
                ...
                if ($xml) {
                    if ($xml->channel) {
                        ...
                        $sql = "INSERT INTO public.volcanic_test(
                 gdacs_id, created_at, crisis_alert_level, crisis_event_episode, crisis_population, crisis_severity, crisis_severity_hash, crisis_vulnerability, crisis_vulnerability_hash, dc_date, dc_description, dc_title, gn_parent_country, geom)
                  VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, st_setsrid(ST_MakePoint(?,?),4326));";
                        ...
                        $sql = "INSERT INTO public.volcanic_test( gdacs_id, created_at, crisis_alert_level, crisis_event_episode, crisis_population, crisis_severity,  crisis_vulnerability, dc_date, dc_description, dc_title, gn_parent_country, geom)
                    ...
                    if ($todate >= $controldate) {
                        ...
                        if ($crisis_alertLevel != "Green") {
                            ...
                            if ($stmt->execute($params)) {
                                echo "INSERITO IN volcanic_test $gdacs_id WITH EVENT EPISODE : $event_episode <br>";
                                ...
                                $updateSql = 'UPDATE public.volcanic_test
              ...
              /*  print "\n";
                ...
                if ($xml) {
                    if ($xml->channel) {
                        ...
                        $sqlupdate_test = "UPDATE public.volcanic_test
